...
if(isset($_POST['register'])){
  $name=mysqli_real_escape_string($con,$_POST['username']);
	...
	$sel_email="select * from admin where email='$email'";
	...
	if($check_email==1){
      ...
      echo"<script>window.open('admin_login.php','_self')</script>";
		...
		$insert="INSERT INTO `admin` (`id`, `username`, `email`, `password`,`password_confirm`) VALUES (NULL, '$username', '$email', '$password', '$password_confirm')";
